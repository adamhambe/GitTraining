...
public class AdamHInl13_Program_List {
...
//	This is the constructor that I call in the main method
	public AdamHInl13_Program_List() {
...
//		I declare the three Lists that I need
		List<String> arrNamn = new ArrayList<String>();
		List<Integer> arrPoäng = new ArrayList<Integer>();
		List<String> arrBetyg = new ArrayList<String>();
